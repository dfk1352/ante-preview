...
| `policy` | Default permission policy (`default`, `auto`, or `yolo`) |
...
| `context-left` | Percent of the usable context window remaining (omitted until known) |
...
```json
{
  ...
  "context": { "pct_left": 82, "used_tokens": 36000, "limit_tokens": 200000 },
  "provider": "anthropic"
}
```
